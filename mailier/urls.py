...
urlpatterns = [
    ...
    path('client/list/', cache_page(30)(ClientListView.as_view()), name='client_list'),
    path('mailing/form/', MailingCreateView.as_view(), name='mailing_create'),
    path('mailing/update/<int:pk>/', MailingUpdateView.as_view(), name='mailing_update'),
    path('mailing/list/', cache_page(30)(MailingListView.as_view()), name='mailing_list'),
    ...
    path('msg/list/', cache_page(30)(MsgListView.as_view()), name='msg_list'),
